...
<head>
    ...
    <link rel="stylesheet" href="css/cwnXtech Stylesheet.css"> <!--Untuk Css Utama-->
    <link rel="stylesheet" href="css/Xcss2.css"> <!--ini sya untuk animate-->
    <link rel="stylesheet" href="css/Logo.css"> <!--buat logo ataupun font, cuma saya belum pakai-->
    <link rel="icon" href="icon/Cwn QuantumHorizon without teks and without background.png">
    <title>CwnXtech | Event & Conference</title>
    <script src="https://unpkg.com/feather-icons"></script> <!--Untuk icon tarik (icon aja) LIBARY ICON SVG BUKAN FRAMEWORK-->
...
?>
    <header>
        <div class="container">
            <nav>
                 <img src="icon/Cwn QuantumHorizon without teks and without background.png" alt="logo" class ="logo">
                <ul class="nav-links">
                    <li><a href="#">Home</a></li>
                    <li class="dropdown">
...
<div class="event-grid">
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/20" alt="AI Revolution" class="event-img">
                        <div class="event-badge">Tech</div>
                    </div>
                    <div class="event-info">
                        <h3>AI Revolution Summit</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Nov 15-17, 2023
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> San Francisco
                            </span>
                        </div>
                        <p class="event-desc">Explore the future of artificial intelligence with leading researchers and industry pioneers.</p>
                        <div class="event-cta">
                            <a href="#" class="btn event-details-btn">Learn More</a>
                            <span class="event-price">$499 <small>Early Bird</small></span>
                        </div>
                ...
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/21" alt="Web3 Conference" class="event-img">
                        <div class="event-badge">Blockchain</div>
                    </div>
                    <div class="event-info">
                        <h3>Web3 & Blockchain Expo</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Dec 5-7, 2023
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> New York
                            </span>
                        </div>
                        <p class="event-desc">Dive into decentralized technologies, NFTs, and the future of digital ownership.</p>
                        <div class="event-cta">
                            <a href="#" class="btn">Learn More</a>
                            <span class="event-price">$599 <small>Early Bird</small></span>
                        </div>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/22" alt="Cyber Security" class="event-img">
                        <div class="event-badge">Security</div>
                    </div>
                    <div class="event-info">
                        <h3>Cyber Security Forum</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Jan 10-12, 2024
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> London
                            </span>
                        </div>
                        <p class="event-desc">Learn from top security experts about protecting digital assets in an evolving threat landscape.</p>
                        <div class="event-cta">
                            <a href="#" class="btn">Learn More</a>
                            <span class="event-price">$549 <small>Early Bird</small></span>
                        </div>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/23" alt="Cloud Computing" class="event-img">
                        <div class="event-badge">Cloud</div>
                    </div>
                    <div class="event-info">
                        <h3>Cloud Computing Summit</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Feb 14-16, 2024
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> Seattle
                            </span>
                        </div>
                        <p class="event-desc">Discover the latest in cloud infrastructure, serverless architectures and distributed systems.</p>
                        <div class="event-cta">
                            <a href="#" class="btn">Learn More</a>
                            <span class="event-price">$449 <small>Early Bird</small></span>
                        </div>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/24" alt="DevOps Days" class="event-img">
                        <div class="event-badge">DevOps</div>
                    </div>
                    <div class="event-info">
                        <h3>DevOps Days</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Mar 5-7, 2024
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> Austin
                            </span>
                        </div>
                        <p class="event-desc">Master CI/CD pipelines, infrastructure as code, and modern deployment strategies.</p>
                        <div class="event-cta">
                            <a href="#" class="btn">Learn More</a>
                            <span class="event-price">$399 <small>Early Bird</small></span>
                        </div>
                    </div>
                </div>
                <div class="event-card">
                    <div class="event-media-container">
                        <img src="http://static.photos/technology/640x360/25" alt="Data Science" class="event-img">
                        <div class="event-badge">Data</div>
                    </div>
                    <div class="event-info">
                        <h3>Data Science Conference</h3>
                        <div class="event-meta">
                            <span class="event-date">
                                <i data-feather="calendar"></i> Apr 18-20, 2024
                            </span>
                            <span class="event-location">
                                <i data-feather="map-pin"></i> Boston
                            </span>
                        </div>
                        <p class="event-desc">Advanced analytics, machine learning models, and data visualization techniques.</p>
                        <div class="event-cta">
                            <a href="#" class="btn">Learn More</a>
                            <span class="event-price">$599 <small>Early Bird</small></span>
                        </div>
...
<table class="schedule-table">
    ...
    <div class="Container-Tiket">
      ...
      <div class="input-tiket">
        ...
        <input type="text" id="tiket" class="inputStyle" />
      </div>
      <div class="input-tiket">
        <label class="labelTiket">JUMLAH</label>
        <input type="number" id="jumlah-tiket" class="inputStyle" />
      </div>
      <div class="input-tiket">
        <label class="labelTiket">HARGA SATUAN (RP)</label>
        <input type="number" id="harga-tiket" class="inputStyle" />
      </div>
      <button class="button-tiket" onclick="proses()">HITUNG TOTAL</button>
      <button class="button-tiket" onclick="hapus()">HAPUS</button>
    ...
    <section id="register" class="cta">
        <div class="container">
            ...
            <a href="#" class="btn register-btn">Register Today</a>
        </div>
    ...
    <footer>
        ...
        <div class="copyright">
            <p>&copy; 2025 GRIVIN WILLIAM REVEL. All rights reserved. <span class="block sm:inline">Contact Me: gr1vin.gamer@gmail.com | +62 82150245906</span></p>
...
(async function loadEvents() {
  ...
  try {
    const events = await fetchEventsJson(url);
    // simple display: add a small badge to header with count
    const count = Array.isArray(events) ? events.length : 0;
    const badge = document.createElement('span');
    badge.textContent = count + ' remote events loaded';
    ...
    console.warn('Could not fetch events.json (this is optional):', err);
  }
})();

// ===== Expose a small API to clear assistant-created storage =====
window.__assist_clear_storage = function() {
  ['sub_email','lastHover','lastContact','fetched_events','site_theme'].forEach(k => localStorage.removeItem(k));
